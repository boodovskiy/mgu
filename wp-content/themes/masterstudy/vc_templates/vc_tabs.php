...
foreach ( $tab_titles as $tab ) {
	...
	if ( isset( $tab_atts['title'] ) ) {
		$tabs_nav .= '<li class="heading_font" style="width:'.esc_attr($tab_width).'%"><a href="#tab-' . ( isset( $tab_atts['tab_id'] ) ? $tab_atts['tab_id'] : sanitize_title( $tab_atts['title'] ) ) . '">' . $tab_atts['title'] . '</a></li>';
	}
}
$tabs_nav .= '</ul>' . "\n";
