						...
						<td class="product-name">
							...
							<?php
								if ( ! $_product->is_visible() ) {
									...
									echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a class="h5" href="%s">%s </a>', esc_url( $_product->get_permalink( $cart_item ) ), $_product->get_title() ), $cart_item, $cart_item_key );
								}
