...
class Stm_Contacts_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if(!empty($instance['phone'])){
			echo '<li><div class="icon"><i class="fa-icon-stm_icon_phone"></i></div><div class="text">' . html_entity_decode( $instance['phone'] ) . '</div></li>';
		}

		if(!empty($instance['fax'])){
			echo '<li><div class="icon"><i class="fa-icon-stm_icon_fax"></i></div><div class="text">' . html_entity_decode( $instance['fax'] ) . '</div></li>';
		}
